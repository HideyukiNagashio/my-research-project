...
class HybridEdgeConvModelD(nn.Module):
    """
    EdgeConvハイブリッドモデル (モデルD)
    - 位置エンコーディング: Learned (学習可能)
    - スケール調整: なし
    - 最終出力層: 2層 (128 -> 64 -> 3)
    """
    def __init__(self, input_dim=14, output_dim=3, use_shortcut=False, seq_len=200, 
        ...
        super(HybridEdgeConvModelD, self).__init__()
