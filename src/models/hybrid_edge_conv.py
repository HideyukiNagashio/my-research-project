...
class HybridEdgeConvModel(nn.Module):
    def __init__(self, input_dim=14, output_dim=3, use_shortcut=True, seq_len=200, 
                 gnn_out_dim=16, cnn_pool_dim=32, 
                 d_model=128, nhead=4, num_layers=3, dim_feedforward=256, dropout_prob=0.1):
        super(HybridEdgeConvModel, self).__init__()
        ...
        # EdgeConv 1
        # EdgeConv takes nn taking 2 * in_channels
        mlp1 = nn.Sequential(
